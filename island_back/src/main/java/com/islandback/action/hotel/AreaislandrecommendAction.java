...
@Namespace("/hotel/areaisland")
@ResultPath("/WEB-INF")
public class AreaislandrecommendAction extends BaseAction {
	...
	public String add(){
		...
		recommend.setModuleId(ModuleEnum.HOTEL_PACKAGE_INDEX_AREA_RECOMMEND);
		if(image != null ){
	...
	public String del(){
		...
		islandParams.put("moduleId", ModuleEnum.HOTEL_PACKAGE_INDEX_AREA_RECOMMEND);
	...
	private void doList(){
		...
		if(list != null && list.size()>0){
			...
			countParam.put("moduleId", ModuleEnum.HOTEL_PACKAGE_INDEX_AREA_RECOMMEND);
