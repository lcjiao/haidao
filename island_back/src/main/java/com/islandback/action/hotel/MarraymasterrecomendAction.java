...
public class MarraymasterrecomendAction extends ActionSupport {
	...
	private void doList(){
		...
		Map<String,Object> params = new HashMap<String,Object>(0);
		params.put("moduleId", ModuleEnum.HOTEL_PACKAGE_INDEX_MASTER_RECOMMEND);
		params.put("valid", 1);
		Page page = new Page();
		...
		if(list != null && list.size()>0){
			...
			countParam.put("moduleId", ModuleEnum.HOTEL_PACKAGE_INDEX_MASTER_RECOMMEND);
