...
public class MarraymasterrecomendAction extends ActionSupport {
	...
	public String add(){
		...
		recommend.setModuleId(ModuleEnum.FREEWALK_PACKAGE_INDEX_MASTER_RECOMMEND);
		if(image != null ){
	...
	private void doList(){
		...
		Map<String,Object> params = new HashMap<String,Object>(0);
		params.put("moduleId", ModuleEnum.FREEWALK_PACKAGE_INDEX_MASTER_RECOMMEND);
		params.put("valid", 1);
		Page page = new Page();
		...
		if(list != null && list.size()>0){
			...
			countParam.put("moduleId", ModuleEnum.FREEWALK_PACKAGE_INDEX_MASTER_RECOMMEND);
