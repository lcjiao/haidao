...
@Namespace("/company/workmate")
@ResultPath("/WEB-INF")
public class WorkmateAction extends ActionSupport {
	...
	public String add(){
		...
		recommend.setModuleId(ModuleEnum.COMPANY_MATE);
		if(image != null ){
	...
	private void doList(){
		...
		Map<String,Object> params = new HashMap<String,Object>(0);
		params.put("moduleId", ModuleEnum.COMPANY_MATE);
		params.put("valid", 1);
		Page page = new Page();
		...
		if(list != null && list.size()>0){
			...
			countParam.put("moduleId", ModuleEnum.COMPANY_MATE);
