...
@Namespace("/company/friend")
@ResultPath("/WEB-INF")
public class CompanyfriendAction extends ActionSupport {
	...
	public String add(){
		...
		recommend.setModuleId(ModuleEnum.COMPANY_FRIEND);
		if(image != null ){
	...
	private void doList(){
		...
		Map<String,Object> params = new HashMap<String,Object>(0);
		params.put("moduleId", ModuleEnum.COMPANY_FRIEND);
		params.put("valid", 1);
		Page page = new Page();
		...
		if(list != null && list.size()>0){
			...
			countParam.put("moduleId", ModuleEnum.COMPANY_FRIEND);
