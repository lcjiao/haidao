...
@Namespace("/globalnet/recommendtwo")
@ResultPath("/WEB-INF")
public class RecommendtwoAction extends ActionSupport {
	...
	public String add(){
		...
		recommend.setModuleId(ModuleEnum.GLOBAL_RECOMMEND_TWO);
		if(image != null ){
	...
	private void doList(){
		...
		Map<String,Object> params = new HashMap<String,Object>(0);
		params.put("moduleId", ModuleEnum.GLOBAL_RECOMMEND_TWO);
		params.put("valid", 1);
		Page page = new Page();
		...
		if(list != null && list.size()>0){
			...
			countParam.put("moduleId", ModuleEnum.GLOBAL_RECOMMEND_TWO);
