 ...
 *
 */
public class WeddingphotoAction extends ActionSupport implements ServletResponseAware {
	private static final long serialVersionUID = 1L;
	private Recommend recommend;
	private IslandPackage islandPackage;
	...
	private List<IslandPackage> islandPackageList = new ArrayList<IslandPackage>(0);
	...
	private void doList(){
		...
		List<IslandPackage> list = weddingPhotoBiz.queryIslandPackageByMap(map);
		if(list != null && list.size()>0){
			this.totalSize = weddingPhotoBiz.countIslandPackageByMap(map);
		}
		initTotalPageSize();
		this.islandPackageList = list;
	}
	...
	public List<IslandPackage> getIslandPackageList() {
		return islandPackageList;
	}

	public void setIslandPackageList(List<IslandPackage> islandPackageList) {
		this.islandPackageList = islandPackageList;
	}
	...
	public IslandPackage getIslandPackage() {
		return islandPackage;
	}

	public void setIslandPackage(IslandPackage islandPackage) {
		this.islandPackage = islandPackage;
	}
