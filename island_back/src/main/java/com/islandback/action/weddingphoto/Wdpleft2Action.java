...
@Namespace("/weddingphoto/wdpleft2")
@ResultPath("/WEB-INF")
/**
 *婚纱摄影左边上三块图片推荐action
 *
 */
public class Wdpleft2Action extends ActionSupport implements ServletResponseAware {
	...
	private void doList(){
		map.clear();
		map.put("moduleId", ModuleEnum.WEDDING_PHOTO_FACE_LEFT2_RECOMMEND);
		map.put("valid", 1);
		Page page = new Page();
	...
	public String addWdpRecommend(){
		...
		recommend.setModuleId(ModuleEnum.WEDDING_PHOTO_FACE_LEFT2_RECOMMEND);
