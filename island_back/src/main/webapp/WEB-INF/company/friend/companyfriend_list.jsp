...
<script>
	...
	function newCreate(){
		var url = "${ctx}/company/friend/companyfriend!toAdd.action";
		window.location.href = url;
	};
	...
	function del(ele){
		...
		if(isHide){
			...
			var url = "${ctx}/company/friend/companyfriend!del.action?id="+recommendId;
			window.location.href = url; 
		}
	}
	...
	function edit(ele){
		var recommendId = $(ele).attr('title');
		var url =  "${ctx}/company/friend/companyfriend!toEdit.action?id="+recommendId;
		window.location.href = url; 
	}
