...
<body>
<form action="${ctx}/company/friend/companyfriend!edit.action" enctype="multipart/form-data" id="form" method="post">
...
function resetData(){
	var link = "${ctx}/company/friend/companyfriend!tolist.action";
