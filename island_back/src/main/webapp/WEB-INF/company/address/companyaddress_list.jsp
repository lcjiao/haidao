...
<script>
	...
	function newCreate(){
		var url = "${ctx}/company/address/companyaddress!toAdd.action";
		window.location.href = url;
	};
	...
	function del(ele){
		...
		if(isHide){
			...
			var url = "${ctx}/company/address/companyaddress!del.action?id="+recommendId;
			window.location.href = url; 
		}
	}
	...
	function edit(ele){
		var recommendId = $(ele).attr('title');
		var url =  "${ctx}/company/address/companyaddress!toEdit.action?id="+recommendId;
		window.location.href = url; 
	}
