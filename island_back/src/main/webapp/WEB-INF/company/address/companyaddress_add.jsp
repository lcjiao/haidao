...
<body>
<form action="${ctx}/company/address/companyaddress!add.action" enctype="multipart/form-data" id="form" method="post">
...
function resetData(){
	var link = "${ctx}/company/address/companyaddress!tolist.action";
