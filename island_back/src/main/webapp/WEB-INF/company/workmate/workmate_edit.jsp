...
<body>
<form action="${ctx}/company/workmate/workmate!edit.action" enctype="multipart/form-data" id="form" method="post">
...
<table class="datalist" width="100%">
	<tbody>
		...
		<tr>
			<td>描述</td>
			<td><textarea style="width:264px;height:50px;" class="text" id="desc" name="recommend.recommendDesc"  style="_width:316px;">${recommend.recommendDesc}</textarea></td>					
		</tr>
		<tr>
			<td>图片</td>
...
function resetData(){
	var link = "${ctx}/company/workmate/workmate!tolist.action";
