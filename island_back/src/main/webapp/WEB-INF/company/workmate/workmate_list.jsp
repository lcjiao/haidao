...
<script>
	...
	function newCreate(){
		var url = "${ctx}/company/workmate/workmate!toAdd.action";
		window.location.href = url;
	};
	...
	function del(ele){
		...
		if(isHide){
			...
			var url = "${ctx}/company/workmate/workmate!del.action?id="+recommendId;
			window.location.href = url; 
		}
	}
	...
	function edit(ele){
		var recommendId = $(ele).attr('title');
		var url =  "${ctx}/company/workmate/workmate!toEdit.action?id="+recommendId;
		window.location.href = url; 
	}
