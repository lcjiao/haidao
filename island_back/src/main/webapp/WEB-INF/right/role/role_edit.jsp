...
<body>
<form action="${ctx}/right/role/role!updRole.action" id="form" method="post">
<div  class="creatcustomer" >
<table class="datalist" width="100%">
	<tbody>
		<tr>
			<td>角色名</td>
			<td><input type=text class="text" value="${roleName}" id="role_name" name="roleName"  style="_width:316px;"/></td>					
		</tr>
