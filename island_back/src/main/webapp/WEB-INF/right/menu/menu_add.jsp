...
<body>
<form action="${ctx}/right/menu/menu!addMenu.action" id="form" method="post">
<div  class="creatcustomer" >
<table class="datalist" width="100%">
	<tbody>
		<tr>
			<td>菜单名</td>
			<td><input type=text class="text" value="" id="menu_name" name="menuName"  style="_width:316px;"/></td>					
		</tr>
		
		<tr>
			<td>菜单url</td>
			<td><input type=text class="text" value="" id="menu_url" name="menuUrl"  style="_width:316px;"/></td>					
		</tr>
