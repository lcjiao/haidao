...
<form action="${ctx}/hotel/package/package!toImgList.action" id="form" method="post">
...
<script>
	...
	function newCreate(){
		...
		var url = "${ctx}/hotel/package/package!toAddImg.action?id="+packageId;
	...
	function editImg(ele){
		...
		var packageId =$("#p_id").val();
		var url =  "${ctx}/hotel/package/package!toEditImg.action?imgId="+imgId+"&id="+packageId;
		window.location.href = url; 
	}
	function delImg(ele){
		...
		if(isHide){
			var imgId = $(ele).attr('title');
			var packageId =$("#p_id").val();
			var url =  "${ctx}/hotel/package/package!delImg.action?imgId="+imgId+"&id="+packageId;
			window.location.href = url; 
		}
	}
