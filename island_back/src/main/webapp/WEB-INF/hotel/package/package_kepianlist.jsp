...
<form action="${ctx}/hotel/package/package!toKepianList.action" id="form" method="post">
...
<script>
	...
	function newCreate(){
		...
		var url = "${ctx}/hotel/package/package!toAddKepian.action?id="+packageId;
	...
	function editKepian(ele){
		...
		var packageId =$("#p_id").val();
		var url =  "${ctx}/hotel/package/package!toEditKepian.action?kepianId="+kepianId+"&id="+packageId;
		window.location.href = url; 
	}
	function delKepian(ele){
		...
		if(isHide){
			var kepianId = $(ele).attr('title');
			var packageId =$("#p_id").val();
			var url =  "${ctx}/hotel/package/package!delKepian.action?kepianId="+kepianId+"&id="+packageId;
			window.location.href = url; 
		}
	}
