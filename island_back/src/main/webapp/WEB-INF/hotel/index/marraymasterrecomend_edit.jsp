...
<body>
<form action="${ctx}/hotel/index/marraymasterrecomend!edit.action" enctype="multipart/form-data" id="form" method="post">
...
function resetData(){
	var url =  "${ctx}/hotel/index/marraymasterrecomend!tolist.action";
