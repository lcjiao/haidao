...
<form action="${ctx}/hotel/areaisland/areaislandrecommend!tolist.action" id="form" method="post">
...
<script>
	...
	function newCreate(){
		var url = "${ctx}/hotel/areaisland/areaislandrecommend!toAdd.action";
		window.location.href = url;
	};
	...
	function del(ele){
		...
		if(isHide){
			...
			var url = "${ctx}/hotel/areaisland/areaislandrecommend!del.action?id="+recommendId;
			window.location.href = url; 
		}
	}
	...
	function edit(ele){
		var recommendId = $(ele).attr('title');
		var url =  "${ctx}/hotel/areaisland/areaislandrecommend!toEdit.action?id="+recommendId;
		window.location.href = url; 
	}
