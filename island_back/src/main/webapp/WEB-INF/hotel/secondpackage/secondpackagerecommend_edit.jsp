...
<body>
<form action="${ctx}/hotel/secondpackage/secondpackagerecommend!edit.action" enctype="multipart/form-data" id="form" method="post">
...
function resetData(){
	var url =  "${ctx}/hotel/secondpackage/secondpackagerecommend!tolist.action";
