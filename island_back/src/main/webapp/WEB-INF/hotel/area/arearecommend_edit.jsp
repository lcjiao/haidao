...
<body>
<form action="${ctx}/hotel/area/arearecommend!edit.action" enctype="multipart/form-data" id="form" method="post">
...
function resetData(){
	var url =  "${ctx}/hotel/area/arearecommend!tolist.action";
