...
<body>
<form action="${ctx}/hotel/areapackage/areapackagerecommend!edit.action" enctype="multipart/form-data" id="form" method="post">
...
function resetData(){
	var url =  "${ctx}/hotel/areapackage/areapackagerecommend!tolist.action";
