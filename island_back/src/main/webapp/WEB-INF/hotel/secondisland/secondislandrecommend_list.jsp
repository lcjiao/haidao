...
<script>
	...
	function findByNo(pageNo){
		var url = "${ctx}/hotel/secondisland/secondislandrecommend!tolist.action?pageNo="+pageNo;
		window.location.href = url;
	}
	
	
	function newCreate(){
		var url = "${ctx}/hotel/secondisland/secondislandrecommend!toAdd.action";
		window.location.href = url;
	};
	...
	function edit(ele){
		var recommendId = $(ele).attr('title');
		var url =  "${ctx}/hotel/secondisland/secondislandrecommend!toEdit.action?id="+recommendId;
		window.location.href = url; 
	}
