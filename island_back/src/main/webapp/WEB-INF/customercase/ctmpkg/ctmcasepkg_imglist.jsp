...
<body>
<form action="${ctx}/customercase/ctmpkg/ctmcasepkg!imgCaseSearch.action" id="form" method="post">
<table class="searchbar" style="width: 100%">
	<tbody>
		<tr>
			...
			<td>
				<input class="btn" type="button" value="搜索" id="search"/>
			</td>
		</tr>
	</tbody>
</table>
			...
			<td colspan="2">
				<table class="datalist ask_rel" style="width: 100%">
					...
					<tbody id="question_list">
						<s:iterator value="casePMList" status="_index">
							<tr>
								...
								<td style="text-align:center;">
									<img style="width:150px;height:120px;" alt="你想看我吗？哈哈！！" src='<s:property value="pictureurl"/>'>
								</td>
								<td style="text-align:center;">
									<s:property value="picturedesc"/>
								</td>
								<td style="text-align:center;">
...
<script>
	...
	function newCreate(){
		var url = "${ctx}/customercase/ctmpkg/ctmcasepkg!toAddImg.action?ctmId="+ctmId;
		window.location.href = url;
	};
	
	function editImg(ele){
		var ctmImgId = $(ele).attr('title');
		var url =  "${ctx}/customercase/ctmpkg/ctmcasepkg!toEditImg.action?ctmImgId="+ctmImgId;
		window.location.href = url; 
	}
	function delImg(ele){
		var ctmImgId = $(ele).attr('title');
		...
		if(isHide){
			var url =  "${ctx}/customercase/ctmpkg/ctmcasepkg!delImgcase.action?ctmImgId="+ctmImgId;
			window.location.href = url; 
		}
	}
