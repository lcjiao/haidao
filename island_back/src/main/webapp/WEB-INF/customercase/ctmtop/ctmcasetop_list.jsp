...
<script>
	...
	function findByNo(pageNo){
		var url = "${ctx}/customercase/ctmtop/ctmcasetop!list?pageNo="+pageNo;
		window.location.href = url;
	}
	
	
	function newCreate(){
		var url = "${ctx}/customercase/ctmtop/ctmcasetop!toAdd.action";
		window.location.href = url;
	};
	...
	function del(ele){
		...
		if(isHide){
			...
			var url = "${ctx}/customercase/ctmtop/ctmcasetop!deleteCtmCaseImgRmd.action?rmdId="+recommendId;
			window.location.href = url; 
		}
	}
	...
	function edit(ele){
		var recommendId = $(ele).attr('title');
		var url =  "${ctx}/customercase/ctmtop/ctmcasetop!toEditCtmCaseImg.action?rmdId="+recommendId;
		window.location.href = url; 
	}
</script>
</html>