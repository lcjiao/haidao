...
<script>
	...
	function findByNo(pageNo){
		var url = "${ctx}/customercase/image/imgrmd!list?pageNo="+pageNo;
		window.location.href = url;
	}
	
	
	function newCreate(){
		var url = "${ctx}/customercase/image/imgrmd!toAdd.action";
		window.location.href = url;
	};
	...
	function del(ele){
		...
		if(isHide){
			...
			var url = "${ctx}/customercase/image/imgrmd!deleteImgRmd.action?rmdId="+recommendId;
			window.location.href = url; 
		}
	}
	...
	function edit(ele){
		var recommendId = $(ele).attr('title');
		var url =  "${ctx}/customercase/image/imgrmd!toEditImgRmd.action?rmdId="+recommendId;
		window.location.href = url; 
	}
</script>
</html>