...
<body>
<form action="${ctx}/customercase/image/imgrmd!addImgRmd.action" enctype="multipart/form-data" id="form" method="post">
...
<table class="datalist" style="width: 100%">
	<tbody>
		...
		<tr>
			<td>图片链接</td>
			<td>
				<input type="text" class="text" id="link_url" name="recommend.linkUrl"/>
			</td>
		</tr>
		<tr>
			<td>描述</td>
