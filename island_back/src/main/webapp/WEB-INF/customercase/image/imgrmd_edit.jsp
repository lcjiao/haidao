...
<body>
<form action="${ctx}/customercase/image/imgrmd!editImgRmd.action" enctype="multipart/form-data" id="form" method="post">
...
<table class="datalist" style="width: 100%">
	<tbody>
		...
		<tr>
			<td>图片链接</td>
			<td>
				<input type="text" class="text" id="link_url" name="recommend.linkUrl" value="${recommend.linkUrl }" style="_width:316px;"/>
			</td>
		</tr>
		<tr>
			<td>描述</td>
...
<script>
	...
	function setIsland(){
		...
		if(areaId != null){
			...
			$.ajax({
				url:"${ctx}/customercase/image/imgrmd!getIslandSelect.action",
				type: "POST",
		        dataType: "json",
		        data: data,
