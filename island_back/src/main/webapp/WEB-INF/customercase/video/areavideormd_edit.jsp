...
<body>
<form action="${ctx}/customercase/video/areavideormd!editVideoRmd.action" enctype="multipart/form-data" id="form" method="post">
...
<table class="datalist" style="width: 100%">
	<tbody>
		...
		<tr>
			<td>视频地址</td>
			<td>
				<input type="text" class="text" id="view_link" name="recommend.viewLink" value="${recommend.viewLink }" style="_width:316px;"/>
			</td>
		</tr>
		<tr>
			<td>描述</td>
