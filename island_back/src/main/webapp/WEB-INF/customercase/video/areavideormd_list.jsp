...
<script>
	...
	function findByNo(pageNo){
		var url = "${ctx}/customercase/video/areavideormd!list?pageNo="+pageNo;
		window.location.href = url;
	}
	
	
	function newCreate(){
		var url = "${ctx}/customercase/video/areavideormd!toAdd.action";
		window.location.href = url;
	};
	...
	function del(ele){
		...
		if(isHide){
			...
			var url = "${ctx}/customercase/video/areavideormd!deleteVideoRmd.action?rmdId="+recommendId;
			window.location.href = url; 
		}
	}
	...
	function edit(ele){
		var recommendId = $(ele).attr('title');
		var url =  "${ctx}/customercase/video/areavideormd!toEditVideoRmd.action?rmdId="+recommendId;
		window.location.href = url; 
	}
</script>
</html>