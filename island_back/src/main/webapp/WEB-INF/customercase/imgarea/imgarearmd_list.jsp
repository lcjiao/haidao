...
<script>
	...
	function findByNo(pageNo){
		var url = "${ctx}/customercase/imgarea/imgarearmd!tolist.action?pageNo="+pageNo;
		window.location.href = url;
	}
	
	
	function newCreate(){
		var url = "${ctx}/customercase/imgarea/imgarearmd!toAdd.action";
		window.location.href = url;
	};
	...
	function del(ele){
		...
		if(isHide){
			...
			var url = "${ctx}/customercase/imgarea/imgarearmd!del.action?id="+recommendId;
			window.location.href = url; 
		}
	}
	...
	function edit(ele){
		var recommendId = $(ele).attr('title');
		var url =  "${ctx}/customercase/imgarea/imgarearmd!toEdit.action?id="+recommendId;
		window.location.href = url; 
	}
