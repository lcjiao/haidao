...
<body>
<form action="${ctx}/weddingphoto/wdpleft2/wdpleft2!editRecommend.action" enctype="multipart/form-data" id="form" method="post">
...
<table class="datalist" style="width: 100%">
	...
	<!-- 	<tr>
		...
		<tr>
			<td>时间</td>
			<td><input type=text class="text" value="${recommend.recommendTime }" id="title" name="recommend.recommendTime" style="_width:316px;"/></td>
		</tr>
		<tr>
			<td>排序</td>
