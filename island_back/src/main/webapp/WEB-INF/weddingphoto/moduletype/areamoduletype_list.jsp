...
<form action="${ctx}/weddingphoto/moduletype/areamoduletype!tolist.action" id="form" method="post">
...
<script>
	...
	function findByNo(pageNo){
		//var url = "${ctx}/weddingphoto/secondpackage/secondpackagerecommend!tolist.action?pageNo="+pageNo;
	...
	function newCreate(){
		var url = "${ctx}/weddingphoto/moduletype/areamoduletype!toAdd.action";
		window.location.href = url;
	};
	...
	function del(ele){
		...
		if(isHide){
			...
			var url = "${ctx}/weddingphoto/moduletype/areamoduletype!del.action?id="+recommendId;
			window.location.href = url; 
		}
	}
	...
	function edit(ele){
		var recommendId = $(ele).attr('title');
		var url =  "${ctx}/weddingphoto/moduletype/areamoduletype!toEdit.action?id="+recommendId;
		window.location.href = url; 
	}
