...
<script>
	...
	function findByNo(pageNo){
		var url = "${ctx}/weddingphoto/wdpnew/wdpnew!list?pageNo="+pageNo;
		window.location.href = url;
	}
	
	
	function newCreate(){
		var url = "${ctx}/weddingphoto/wdpnew/wdpnew!toAdd.action";
		window.location.href = url;
	};
	...
	function del(ele){
		...
		if(isHide){
			...
			var url = "${ctx}/weddingphoto/wdpnew/wdpnew!deleteWdp.action?rmdId="+recommendId;
			window.location.href = url; 
		}
	}
	...
	function edit(ele){
		var recommendId = $(ele).attr('title');
		var url =  "${ctx}/weddingphoto/wdpnew/wdpnew!toEditWdp.action?rmdId="+recommendId;
		window.location.href = url; 
	}
</script>
</html>