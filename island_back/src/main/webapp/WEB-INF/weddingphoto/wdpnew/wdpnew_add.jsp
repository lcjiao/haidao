...
<body>
<form action="${ctx}/weddingphoto/wdpnew/wdpnew!addWdpRecommend.action" enctype="multipart/form-data" id="form" method="post">
...
<script>
	...
	function setIsland(){
		...
		if(areaId != null){
			...
			$.ajax({
				url:"${ctx}/weddingphoto/wdpnew/wdpnew!getIslandSelect.action",
				type: "POST",
		        dataType: "json",
		        data: data,
