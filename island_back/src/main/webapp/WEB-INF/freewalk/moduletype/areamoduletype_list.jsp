...
<form action="${ctx}/freewalk/moduletype/areamoduletype!tolist.action" id="form" method="post">
...
<script>
	...
	function newCreate(){
		var url = "${ctx}/freewalk/moduletype/areamoduletype!toAdd.action";
		window.location.href = url;
	};
	...
	function del(ele){
		...
		if(isHide){
			...
			var url = "${ctx}/freewalk/moduletype/areamoduletype!del.action?id="+recommendId;
			window.location.href = url; 
		}
	}
	...
	function edit(ele){
		var recommendId = $(ele).attr('title');
		var url =  "${ctx}/freewalk/moduletype/areamoduletype!toEdit.action?id="+recommendId;
		window.location.href = url; 
	}
