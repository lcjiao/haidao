...
<body>
<form action="${ctx}/freewalk/moduletype/areamoduletype!edit.action" enctype="multipart/form-data" id="form" method="post">
...
function resetData(){
	var url =  "${ctx}/freewalk/moduletype/areamoduletype!tolist.action";
