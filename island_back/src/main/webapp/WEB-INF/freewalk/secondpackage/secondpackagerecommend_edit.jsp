...
<body>
<form action="${ctx}/freewalk/secondpackage/secondpackagerecommend!edit.action" enctype="multipart/form-data" id="form" method="post">
...
function resetData(){
	var url =  "${ctx}/freewalk/secondpackage/secondpackagerecommend!tolist.action";
