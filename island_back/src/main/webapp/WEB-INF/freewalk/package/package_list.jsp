...
<form action="${ctx}/freewalk/package/package!list.action" id="form" method="post">
...
<script>
	...
	function findByNo(pageNo){
		...
		var url = "${ctx}/freewalk/package/package!list.action?islandId="+islandId+"&title="+title+"&price="+price;
	...
	function newCreate(){
		var url = "${ctx}/freewalk/package/package!toAddBase.action";
		window.location.href = url;
	};
	
	function editBase(ele){
		var packageId = $(ele).attr('title');
		var url =  "${ctx}/freewalk/package/package!toEditBase.action?id="+packageId;
		window.location.href = url; 
	}
	
	function editDetail(ele){
		var packageId = $(ele).attr('title');
		var url =  "${ctx}/freewalk/package/package!toManagerDetail.action?id="+packageId;
		window.location.href = url; 
	}
