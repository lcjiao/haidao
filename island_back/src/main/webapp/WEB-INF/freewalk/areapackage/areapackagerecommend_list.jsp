...
<script>
	...
	function newCreate(){
		var url = "${ctx}/freewalk/areapackage/areapackagerecommend!toAdd.action";
		window.location.href = url;
	};
	...
	function del(ele){
		...
		if(isHide){
			...
			var url = "${ctx}/freewalk/areapackage/areapackagerecommend!del.action?id="+recommendId;
			window.location.href = url; 
		}
	}
	...
	function edit(ele){
		var recommendId = $(ele).attr('title');
		var url =  "${ctx}/freewalk/areapackage/areapackagerecommend!toEdit.action?id="+recommendId;
		window.location.href = url; 
	}
