...
<body>
<form action="${ctx}/freewalk/areapackage/areapackagerecommend!add.action" enctype="multipart/form-data" id="form" method="post">
...
function resetData(){
	var url =  "${ctx}/freewalk/areapackage/areapackagerecommend!tolist.action";
