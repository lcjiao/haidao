...
<form action="${ctx}/freewalk/areaisland/areaislandrecommend!tolist.action" id="form" method="post">
					...
					<tbody id="r_list">
						<c:forEach var="recommend" items="${recommendList}">
							<tr >
								...
								<td style="text-align:center;">
									<%-- <a title="${recommend.id}" onclick="edit(this)" >修改排序</a>&nbsp;|&nbsp; --%>
...
<script>
	...
	function findByNo(pageNo){
		//var url = "${ctx}/freewalk/secondpackage/secondpackagerecommend!tolist.action?pageNo="+pageNo;
	...
	function newCreate(){
		var url = "${ctx}/freewalk/areaisland/areaislandrecommend!toAdd.action";
		window.location.href = url;
	};
	...
	function del(ele){
		...
		if(isHide){
			...
			var url = "${ctx}/freewalk/areaisland/areaislandrecommend!del.action?id="+recommendId;
			window.location.href = url; 
		}
	}
	...
	function edit(ele){
		var recommendId = $(ele).attr('title');
		var url =  "${ctx}/freewalk/areaisland/areaislandrecommend!toEdit.action?id="+recommendId;
		window.location.href = url; 
	}
