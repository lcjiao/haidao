...
<script>
	...
	function findByNo(pageNo){
		var url = "${ctx}/freewalk/index/marraymasterrecomend!tolist.action?pageNo="+pageNo;
		window.location.href = url;
	}
	
	
	function newCreate(){
		var url = "${ctx}/freewalk/index/marraymasterrecomend!toAdd.action";
		window.location.href = url;
	};
	...
	function del(ele){
		...
		if(isHide){
			...
			var url = "${ctx}/freewalk/index/marraymasterrecomend!del.action?id="+recommendId;
			window.location.href = url; 
		}
	}
	...
	function edit(ele){
		var recommendId = $(ele).attr('title');
		var url =  "${ctx}/freewalk/index/marraymasterrecomend!toEdit.action?id="+recommendId;
		window.location.href = url; 
	}
