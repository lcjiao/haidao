...
<script>
	...
	function findByNo(pageNo){
		var url = "${ctx}/freewalk/secondisland/secondislandrecommend!tolist.action?pageNo="+pageNo;
		window.location.href = url;
	}
	
	
	function newCreate(){
		var url = "${ctx}/freewalk/secondisland/secondislandrecommend!toAdd.action";
		window.location.href = url;
	};
	...
	function del(ele){
		...
		if(isHide){
			...
			var url = "${ctx}/freewalk/secondisland/secondislandrecommend!del.action?id="+recommendId;
			window.location.href = url; 
		}
	}
	...
	function edit(ele){
		var recommendId = $(ele).attr('title');
		var url =  "${ctx}/freewalk/secondisland/secondislandrecommend!toEdit.action?id="+recommendId;
		window.location.href = url; 
	}
