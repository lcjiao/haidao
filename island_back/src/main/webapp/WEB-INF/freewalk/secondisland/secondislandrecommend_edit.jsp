...
<body>
<form action="${ctx}/freewalk/secondisland/secondislandrecommend!edit.action" enctype="multipart/form-data" id="form" method="post">
...
function resetData(){
	var url =  "${ctx}/freewalk/secondisland/secondislandrecommend!tolist.action";
