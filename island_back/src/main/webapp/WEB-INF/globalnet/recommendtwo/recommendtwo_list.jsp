...
<script>
	...
	function newCreate(){
		var url = "${ctx}/globalnet/recommendtwo/recommendtwo!toAdd.action";
		window.location.href = url;
	};
	...
	function del(ele){
		...
		if(isHide){
			...
			var url = "${ctx}/globalnet/recommendtwo/recommendtwo!del.action?id="+recommendId;
			window.location.href = url; 
		}
	}
	...
	function edit(ele){
		var recommendId = $(ele).attr('title');
		var url =  "${ctx}/globalnet/recommendtwo/recommendtwo!toEdit.action?id="+recommendId;
		window.location.href = url; 
	}
