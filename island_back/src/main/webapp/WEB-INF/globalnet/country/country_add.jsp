...
<body>
<form action="${ctx}/globalnet/country/country!add.action" enctype="multipart/form-data" id="form" method="post">
...
<table class="datalist" width="100%">
	<tbody>
		...
		<tr>
			<td>国家</td>
			<td><input type=text class="text" value="" id="name" name="country.name"  style="_width:316px;"/></td>					
		</tr>
	</tbody>	
</table>
</div>
