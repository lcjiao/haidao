...
<script>
	...
	function newCreate(){
		var url = "${ctx}/globalnet/recommendthree/recommendthree!toAdd.action";
		window.location.href = url;
	};
	...
	function del(ele){
		...
		if(isHide){
			...
			var url = "${ctx}/globalnet/recommendthree/recommendthree!del.action?id="+recommendId;
			window.location.href = url; 
		}
	}
	...
	function edit(ele){
		var recommendId = $(ele).attr('title');
		var url =  "${ctx}/globalnet/recommendthree/recommendthree!toEdit.action?id="+recommendId;
		window.location.href = url; 
	}
