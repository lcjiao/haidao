...
<body>
<form action="${ctx}/globalnet/recommendfour/recommendfour!add.action" enctype="multipart/form-data" id="form" method="post">
...
<table class="datalist" width="100%">
	<tbody>
		...
		<tr>
			<td>描述</td>
			<td><textarea style="width:600px;height:150px;" class="text" id="desc" name="recommend.recommendDesc"  style="_width:316px;"></textarea></td>					
		</tr>
