...
<script>
	...
	function newCreate(){
		var url = "${ctx}/globalnet/recommendfour/recommendfour!toAdd.action";
		window.location.href = url;
	};
	...
	function del(ele){
		...
		if(isHide){
			...
			var url = "${ctx}/globalnet/recommendfour/recommendfour!del.action?id="+recommendId;
			window.location.href = url; 
		}
	}
	...
	function edit(ele){
		var recommendId = $(ele).attr('title');
		var url =  "${ctx}/globalnet/recommendfour/recommendfour!toEdit.action?id="+recommendId;
		window.location.href = url; 
	}
