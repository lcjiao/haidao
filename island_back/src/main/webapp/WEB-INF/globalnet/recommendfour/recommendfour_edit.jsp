...
<body>
<form action="${ctx}/globalnet/recommendfour/recommendfour!edit.action" enctype="multipart/form-data" id="form" method="post">
...
<table class="datalist" width="100%">
	<tbody>
		...
		<tr>
			<td>描述</td>
			<td><textarea class="text" id="title" name="recommend.recommendDesc"  style="width:600px;height:150px;">${recommend.recommendDesc}</textarea></td>					
		</tr>
	</tbody>	
</table>
</div>
...
function resetData(){
	var link = "${ctx}/globalnet/recommendfour/recommendfour!tolist.action";
