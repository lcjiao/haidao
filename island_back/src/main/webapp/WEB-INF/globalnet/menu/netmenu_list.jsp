...
<script>
	...
	function findByNo(pageNo){
		var url = "${ctx}/globalnet/menu/netmenu!list?pageNo="+pageNo;
		window.location.href = url;
	}
	
	
	function newCreate(){
		var url = "${ctx}/globalnet/menu/netmenu!toAdd.action";
		window.location.href = url;
	};
	...
	function del(ele){
		...
		if(isHide){
			...
			var url = "${ctx}/globalnet/menu/netmenu!del.action?id="+recommendId;
			window.location.href = url; 
		}
	}
	...
	function edit(ele){
		var recommendId = $(ele).attr('title');
		var url =  "${ctx}/globalnet/menu/netmenu!toEdit.action?id="+recommendId;
		window.location.href = url; 
	}
