...
<script>
	...
	function findByNo(pageNo){
		var url = "${ctx}/globalnet/friendlink/friendlink!tolist.action?pageNo="+pageNo;
		window.location.href = url;
	}
	
	
	function newCreate(){
		var url = "${ctx}/globalnet/friendlink/friendlink!toAdd.action";
		window.location.href = url;
	};
	...
	function del(ele){
		...
		if(isHide){
			...
			var url = "${ctx}/globalnet/friendlink/friendlink!del.action?id="+recommendId;
			window.location.href = url; 
		}
	}
	...
	function edit(ele){
		var recommendId = $(ele).attr('title');
		var url =  "${ctx}/globalnet/friendlink/friendlink!toEdit.action?id="+recommendId;
		window.location.href = url; 
	}
