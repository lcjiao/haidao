...
<body>
<form action="${ctx}/globalnet/recommendone/recommendone!edit.action" enctype="multipart/form-data" id="form" method="post">
...
function resetData(){
	var link = "${ctx}/globalnet/recommendone/recommendone!tolist.action";
