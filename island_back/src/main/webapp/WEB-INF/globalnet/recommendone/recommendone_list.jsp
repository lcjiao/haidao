...
<script>
	...
	function newCreate(){
		var url = "${ctx}/globalnet/recommendone/recommendone!toAdd.action";
		window.location.href = url;
	};
	...
	function del(ele){
		...
		if(isHide){
			...
			var url = "${ctx}/globalnet/recommendone/recommendone!del.action?id="+recommendId;
			window.location.href = url; 
		}
	}
	...
	function edit(ele){
		var recommendId = $(ele).attr('title');
		var url =  "${ctx}/globalnet/recommendone/recommendone!toEdit.action?id="+recommendId;
		window.location.href = url; 
	}
