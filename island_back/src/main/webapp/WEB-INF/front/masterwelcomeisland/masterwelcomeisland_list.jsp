...
<script>
	...
	function findByNo(pageNo){
		var url = "${ctx}/front/masterwelcomeisland/masterwelcomeisland!list?pageNo="+pageNo;
		window.location.href = url;
	}
	
	
	function newCreate(){
		var url = "${ctx}/front/masterwelcomeisland/masterwelcomeisland!toAdd.action";
		window.location.href = url;
	};
	...
	function del(ele){
		...
		if(isHide){
			...
			var url = "${ctx}/front/masterwelcomeisland/masterwelcomeisland!del.action?id="+recommendId;
			window.location.href = url; 
		}
	}
	...
	function edit(ele){
		var recommendId = $(ele).attr('title');
		var url =  "${ctx}/front/masterwelcomeisland/masterwelcomeisland!toEdit.action?id="+recommendId;
		window.location.href = url; 
	}
