...
<body>
<form action="${ctx}/wdpphototeam/teampackage/teampkg!saveWkmDetail.action" id="form" method="post">
	...
	<tbody>
		<tr>
			...
			<td>
				...
				<input type="hidden" name="workman.id" value="${workman.id }"/>
				<input type="hidden" name="pkgDetailInfo.packageId" value="${workman.id }"/>
				<input type="hidden" name="pkgDetailInfo.packageType" value="3"/>
...
<script>
	...
	function saveAddImg(){
		var url = "${ctx}/wdpphototeam/teampackage/teampkg!back.action";
