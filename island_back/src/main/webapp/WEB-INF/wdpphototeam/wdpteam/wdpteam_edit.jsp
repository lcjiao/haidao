...
<body>
<form action="${ctx}/wdpphototeam/wdpteam/wdpteam!editWdpTeamInfo.action" enctype="multipart/form-data" id="form" method="post">
...
<table class="datalist" style="width: 100%">
	<tbody>		
		<tr>
			<td>标题:</td>
			<td>
				<input type=text class="text" id="title" name="recommend.title" value="${recommend.title }"/>
			</td>
		</tr>
		<tr>
			<td>图片链接</td>
		...
		<tr>
			<td>创作人</td>
			<td>
				<input type=text class="text" id="recommend_desc" name="recommend.recommendDesc" value="${recommend.recommendDesc }" />
			</td>
		</tr>
		<tr>
			<td>创作人简介</td>
			<td><input type="text" class="text" id="content" name="recommend.content" value="${recommend.content }"/></td>	
		</tr>
		<tr>
			<td>排序</td>
			<td>
