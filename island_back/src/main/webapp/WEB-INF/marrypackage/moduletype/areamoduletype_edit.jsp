...
<body>
<form action="${ctx}/marrypackage/moduletype/areamoduletype!edit.action" enctype="multipart/form-data" id="form" method="post">
...
function resetData(){
	var url =  "${ctx}/marrypackage/moduletype/areamoduletype!tolist.action";
