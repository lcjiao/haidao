...
<form action="${ctx}/marrypackage/moduletype/areamoduletype!tolist.action" id="form" method="post">
...
<script>
	...
	function newCreate(){
		var url = "${ctx}/marrypackage/moduletype/areamoduletype!toAdd.action";
		window.location.href = url;
	};
	...
	function del(ele){
		...
		if(isHide){
			...
			var url = "${ctx}/marrypackage/moduletype/areamoduletype!del.action?id="+recommendId;
			window.location.href = url; 
		}
	}
	...
	function edit(ele){
		var recommendId = $(ele).attr('title');
		var url =  "${ctx}/marrypackage/moduletype/areamoduletype!toEdit.action?id="+recommendId;
		window.location.href = url; 
	}
