...
<script>
	...
	function del(ele){
		...
		if(isHide){
			...
			var url = "${ctx}/marrypackage/secondpackage/secondpackagerecommend!del.action?id="+recommendId;
			window.location.href = url; 
		}
	}
	...
	function edit(ele){
		var recommendId = $(ele).attr('title');
		var url =  "${ctx}/marrypackage/secondpackage/secondpackagerecommend!toEdit.action?id="+recommendId;
		window.location.href = url; 
	}
