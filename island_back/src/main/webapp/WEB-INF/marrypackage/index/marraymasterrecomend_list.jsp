...
<script>
	...
	function findByNo(pageNo){
		var url = "${ctx}/marrypackage/index/marraymasterrecomend!tolist.action?pageNo="+pageNo;
		window.location.href = url;
	}
	
	
	function newCreate(){
		var url = "${ctx}/marrypackage/index/marraymasterrecomend!toAdd.action";
		window.location.href = url;
	};
	...
	function del(ele){
		...
		if(isHide){
			...
			var url = "${ctx}/marrypackage/index/marraymasterrecomend!del.action?id="+recommendId;
			window.location.href = url; 
		}
	}
	...
	function edit(ele){
		var recommendId = $(ele).attr('title');
		var url =  "${ctx}/marrypackage/index/marraymasterrecomend!toEdit.action?id="+recommendId;
		window.location.href = url; 
	}
