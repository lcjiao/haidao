...
<form action="${ctx}/marrypackage/areapackage/areapackagerecommend!tolist.action" id="form" method="post">
...
<script>
	...
	function newCreate(){
		var url = "${ctx}/marrypackage/areapackage/areapackagerecommend!toAdd.action";
		window.location.href = url;
	};
	...
	function del(ele){
		...
		if(isHide){
			...
			var url = "${ctx}/marrypackage/areapackage/areapackagerecommend!del.action?id="+recommendId;
			window.location.href = url; 
		}
	}
	...
	function edit(ele){
		var recommendId = $(ele).attr('title');
		var url =  "${ctx}/marrypackage/areapackage/areapackagerecommend!toEdit.action?id="+recommendId;
		window.location.href = url; 
	}
