...
<script>
	...
	function findByNo(pageNo){
		var url = "${ctx}/marrypackage/area/arearecommend!tolist.action?pageNo="+pageNo;
		window.location.href = url;
	}
	
	
	function newCreate(){
		var url = "${ctx}/marrypackage/area/arearecommend!toAdd.action";
		window.location.href = url;
	};
	...
	function del(ele){
		...
		if(isHide){
			...
			var url = "${ctx}/marrypackage/area/arearecommend!del.action?id="+recommendId;
			window.location.href = url; 
		}
	}
	...
	function edit(ele){
		var recommendId = $(ele).attr('title');
		var url =  "${ctx}/marrypackage/area/arearecommend!toEdit.action?id="+recommendId;
		window.location.href = url; 
	}
