...
<body>
<form action="${ctx}/marrypackage/area/arearecommend!edit.action" enctype="multipart/form-data" id="form" method="post">
...
function resetData(){
	var url =  "${ctx}/marrypackage/area/arearecommend!tolist.action";
