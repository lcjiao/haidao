...
<form action="${ctx}/marrypackage/areaisland/areaislandrecommend!tolist.action" id="form" method="post">
...
<script>
	...
	function newCreate(){
		var url = "${ctx}/marrypackage/areaisland/areaislandrecommend!toAdd.action";
		window.location.href = url;
	};
	...
	function edit(ele){
		var recommendId = $(ele).attr('title');
		var url =  "${ctx}/marrypackage/areaisland/areaislandrecommend!toEdit.action?id="+recommendId;
		window.location.href = url; 
	}
