...
<body>
<form action="${ctx}/marrypackage/areaisland/areaislandrecommend!add.action" enctype="multipart/form-data" id="form" method="post">
...
function resetData(){
	var url =  "${ctx}/marrypackage/areaisland/areaislandrecommend!tolist.action";
