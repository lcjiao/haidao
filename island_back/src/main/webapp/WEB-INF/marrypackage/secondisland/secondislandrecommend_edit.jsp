...
<body>
<form action="${ctx}/marrypackage/secondisland/secondislandrecommend!edit.action" enctype="multipart/form-data" id="form" method="post">
...
function resetData(){
	var url =  "${ctx}/marrypackage/secondisland/secondislandrecommend!tolist.action";
