...
<body>
<form action="${ctx}/globalqa/globalqa/globalqa!add.action" enctype="multipart/form-data" id="form" method="post">
...
<table class="datalist" width="100%">
	<tbody>
		...
		<tr>
			<td>问题</td>
			<td><textarea style="width:700px;height:50px;" class="text" id="question" name="globalQa.title"  style="_width:316px;"></textarea></td>					
		</tr>
		<tr>
			<td>解答</td>
			<td>
...
<input type="hidden" value=" " id="answer" name="globalQa.answer"/>
