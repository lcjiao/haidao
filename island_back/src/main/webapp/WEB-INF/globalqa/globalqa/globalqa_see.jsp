...
<body>
<form action="${ctx}/globalqa/globalqa/globalqa!tolist.action" enctype="multipart/form-data" id="form" method="post">
...
<table class="creatcustomer_tfoot" width="100%">
	<tfoot>
		<td>
			<input type=button  value="返回" id="reset" onclick="checkData()"/> 
		</td>
</tfoot>
</table>
</form>
