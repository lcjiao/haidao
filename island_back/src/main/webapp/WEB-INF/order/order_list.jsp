...
<form action="${ctx}/order/order!tolist.action" id="form" method="post">
						...
						<c:forEach var="order" items="${orderList}">
							<tr >
								<td style="text-align:center;">
									<c:out value="${order.country}"></c:out>
								</td>
								<td style="text-align:center;">
									<c:out value="${order.wedArea}"></c:out>
								</td>
								<td style="text-align:center;">
									<c:out value="${order.wedFrom}"></c:out>
								</td>
								<td style="text-align:center;">
									<c:out value="${order.budget}"></c:out>
								</td>
								<td style="text-align:center;">
									<c:out value="${order.wedPersonNum}"></c:out>
								</td>
								<td style="text-align:center;">
									<c:out value="${order.wedName}"></c:out>
								</td>
								<td style="text-align:center;">
									<c:out value="${order.tel}"></c:out>
								</td>
								<td style="text-align:center;">
									<c:out value="${order.qq}"></c:out>
								</td>
								<td style="text-align:center;">
									<c:out value="${order.mail}"></c:out>
								</td>
								<td style="text-align:center;">
									<a title="${order.id}" onclick="detail(this)" >查看详情</a>
								</td>							
						    </tr>
					    </c:forEach>
					</tbody>
...
<script>
	...
	function detail(ele){
		...
		var url =  "${ctx}/order/order!detail.action?id="+id;
